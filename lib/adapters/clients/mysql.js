...
var pool = utilities.define(null, {
    instance :  {
        constructor : function(options) {
            ...
            var max = this.maxConnections = typeof options.maxConnections == "number" ? options.maxConnections : 149;
            this.connections = [], this._used = 0;
            for (var i = 0; i < max; i++) {
                this.connections.push(getConnection(options))
            }
        },
