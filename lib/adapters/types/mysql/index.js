    ...
    if(options.type){
       ...
       var original = options.original;
        if(original){
            ...
            sql += "MODIFY COLUMN " + name + " " + original.sql
        }
...
exports.types = util.merge({}, require("./string"), require("./number"), require("./boolean"), require("./date"));
