    ...
    instance : {
        ...
        inject : function(parent, name) {
            ...
            parent.pre("save", function(next) {
                self._preSave.call(this, next, self)
            });
            parent.pre("update", function(next) {
                self._preUpdate.call(this, next, self)
            });
            parent.pre("remove", function(next) {
                self._preRemove.call(this, next, self);
            });
            parent.pre("load", function(next) {
                self._preLoad.call(this, next, self)
            });

            parent.post("save", function(next) {
                self._postSave.call(this, next, self)
            });
            parent.post("update", function(next) {
                self._postUpdate.call(this, next, self)
            });
            parent.post("remove", function(next) {
                self._postRemove.call(this, next, self)
            });
            parent.post("load", function(next) {
                self._postLoad.call(this, next, self)
            });
...
exports.manyToMany = utility.define(oneToMany, {
    instance : {
        ...
        fetch : function(parent) {
            ...
            q[this.model.table.primaryKey] = {"in" : this.joinTable.getDataset().select(this.rightKey).find(jq).sql};
            return this.model.filter(q).order(this.orderBy)[this._fetchMethod]();
        },
