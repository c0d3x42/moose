...
var Dataset = utility.define(null, {
    instance : {
        ...
        constructor: function(table, db, type, model) {
            ...
            this.model = model;
            this.type = type;
            adapters[type].apply(this, [table, db]);
        },
        ...
        save : function(vals, loadId, callback, errback) {
            ...
            adapters[this.type].save(this.table, vals, this.db).addCallback(hitch(this, function(results) {
                if (loadId) {
                    this.getLastInsertId(hitch(retPromise, "callback"), hitch(retPromise, "errback"));
                } else {
                    retPromise.callback(results);
                    this.close();
                }
...
exports.getDataSet = function(table, db, type, model) {
    var dataset = utility.define(Dataset, {}).mixin(adapters[type]);
