...
var Model = comb.define(null, {
    instance : {
        ...
        __callHook : function(state, op) {
            ...
            if (this.__hooks[state] && this.__hooks[state][op]) {
                ...
                if (length) {
                    var count = 0;
                    var next = comb.hitch(this, function() {
    ...
    static : {
        ...
        load : function(values) {
            ...
            m.__callHook("post", "load").then(comb.hitch(promise, "callback", m));
...
exports.create = function(table, moose, modelOptions) {
    ...
    proto.static.__defineGetter__("table", function() {
        return table;
    });

    proto.static.__defineGetter__("tableName", function() {
        return table.tableName;
    });

    proto.static.__defineGetter__("moose", function() {
        return moose;
    });

    proto.static.__defineGetter__("type", function() {
        return table.type;
    });
    var getters = proto.getters, setters = proto.setters, static = proto.static, instance = proto.instance;
    ...
    merge(getters, modelOptions.getters || {});
    merge(setters, modelOptions.setters || {});
    merge(static, modelOptions.static || {});
    merge(instance, modelOptions.instance || {});
