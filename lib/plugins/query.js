...
var getDataset = function(model, table, hydrate) {
    ...
    var connection = model.moose.getConnection(false), tableName = table.tableName;
...
exports.QueryPlugin = utility.define(null, {
    instance : {
        ...
        reload : function() {
            ...
            getDataset(this.constructor, this.table).find(q).one().then(hitch(retPromise, "callback"), hitch(retPromise, "errback"));
            return retPromise;
        },
        ...
        save : function(options, errback) {
            if (this.__isNew) {
                ...
                this.__callHook("pre", "save").then(hitch(this, function() {
                    getDataset(this, this.table).save(this.toSql(), !thisPk).then(hitch(this, function(res) {
                        this.__isNew = false;
                        this.__isChanged = false;
                        if (pk && !thisPk) {
    ...
    static : {
        ...
        join : function(){
            var d =getDataset(this, this.table, true);
